...
func TestRepository_About(t *testing.T) {
...
func TestRepository_Contact(t *testing.T) {

}

func TestRepository_GeneralRoom(t *testing.T) {
...
func TestRepository_MajorRoom(t *testing.T) {
